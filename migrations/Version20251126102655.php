 ...
 */
final class Version20251126102655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES "organisation" (id) NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
    }
